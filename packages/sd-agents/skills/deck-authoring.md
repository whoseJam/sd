...
trigger: Use when writing or modifying an animation file under examples/decks/<deck>/animation/ or examples/animations/, when invoking pnpm open / close / snap to preview a deck, or when answering questions about the slide layout convention, palette / easing factories, pause semantics, or label discipline for sd decks.
priority: high
---
