...
description: |
  Use when writing or modifying an animation .ts file under examples/decks/<deck>/animation/, or a standalone file under examples/animations/. Covers staggered fade-in entrance, palette/easing factories, await sd.pause() semantics, size-before-center, and narrative-text avoidance.
---
