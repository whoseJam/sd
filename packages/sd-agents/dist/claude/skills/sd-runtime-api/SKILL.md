...
name: "sd-runtime-api"
description: |
  Use when calling any sd.X identifier in a deck animation file, looking up the public surface of @whosejam/sd, choosing between Node subclasses, or picking a layout class from the layout() factory.
---
