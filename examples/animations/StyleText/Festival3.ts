...
sd.main(async () => {
    ...
    textShadow.startAnimate({ duration: breathDuration }).setScale(1.05).endAnimate();
    textMain.startAnimate({ duration: breathDuration }).setScale(1.05).endAnimate();

    textShadow.startAnimate({ delay: breathDuration, duration: breathDuration }).setScale(1.0).endAnimate();
    textMain.startAnimate({ delay: breathDuration, duration: breathDuration }).setScale(1.0).endAnimate();
});
