...
export async function playPart1(group: sd.Group) {
    ...
    const versions = [
        { name: "Version 1", x: 400, color: "#81C784", desc: "Reversible Scheduler", offset: -120 },
        { name: "Version 2", x: 700, color: "#7986CB", desc: "Reactive System", offset: 120 },
        { name: "Simplify", x: 1000, color: "#E57373", desc: "AI Friendly", offset: -120 },
    ];
    ...
    for (const ver of versions) {
        ...
        card.startAnimate().setX(cardX).setY(cardY).setWidth(cardW).setHeight(cardH).endAnimate();
