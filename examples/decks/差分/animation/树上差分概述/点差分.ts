...
const parent: Record<number, number> = {
  2: 1, 3: 1, 4: 2, 5: 2, 6: 4, 7: 4, 8: 6, 9: 6, 10: 7, 11: 9, 12: 10,
};
...
sd.main(async () => {
  ...
  tree.setTag(lca, "-1", C.darkOrange);
  await sd.pause();

  if (faLca !== undefined) {
    tree.paint(faLca, "#fdecd9", C.darkOrange, { duration: 220 });
    tree.setTag(faLca, "-1", C.darkOrange);
    await sd.pause();
  }
});
