...
// Fill F = [[p, q], [1, 0]] for the generalized Fibonacci recurrence
// a_n = p·a_{n-1} + q·a_{n-2}. Same shape and animation as the
// fibonacci version; only the row labels and final matrix values change.
...
const V = makeSimpleGrid(-60, Y, [["a_{n-1}"], ["a_{n-2}"]], 13);
const R = makeSimpleGrid(20, Y, [["a_n"], ["a_{n-1}"]], 13);
