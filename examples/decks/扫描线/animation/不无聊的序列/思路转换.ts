...
// Sequence row on top, n×n (l, r)-plane below. For each i we draw the
// rectangle [L_i+1, i] × [i, R_i-1] in the plane — its area is the number
// of unique subintervals contributed by a_i. If the union of all such
// rectangles covers the upper triangle r >= l (area n(n+1)/2), every
// subinterval is unique and the sequence is "not boring".
