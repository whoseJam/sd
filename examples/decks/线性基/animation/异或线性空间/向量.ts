...
function fadeInRow(row: Cell[], delay = 0) {
  for (let i = 0; i < row.length; i++) {
    row[i].bg
      .startAnimate({ delay: delay + i * 70, duration: DUR, easing: E.easeOut })
      .setOpacity(1)
      .endAnimate();
    row[i].text
      .startAnimate({
...
sd.main(async () => {
  ...
  bLabel
    ...
    .endAnimate();
  oplusLabel
    .startAnimate({ delay: 60, duration: DUR, easing: E.easeOut })
    .setOpacity(1)
    .endAnimate();
  fadeInRow(bRow, 80);
  await sd.pause();
  ...
  sumLine
    ...
    .endAnimate();
  rLabel
    .startAnimate({ delay: 200, duration: DUR, easing: E.easeOut })
    .setOpacity(1)
    .endAnimate();
  for (let i = 0; i < 4; i++) {
    const d = 320 + i * 140;
    ...
    aRow[i].bg
      .startAnimate({ delay: d, duration: 180, easing: E.easeOut })
      .setStroke(ACCENT)
      .setStrokeWidth(1.6)
      .endAnimate();
    aRow[i].bg
      .startAnimate({ delay: d + 380, duration: 220, easing: E.easeOut })
      .setStroke(FAINT)
      .setStrokeWidth(1)
      .endAnimate();
    bRow[i].bg
    ...
    // result cell lands
    rRow[i].bg
      .startAnimate({ delay: d + 120, duration: DUR, easing: E.easeOut })
      .setOpacity(1)
      .setStroke(ACCENT)
      .setStrokeWidth(1.4)
      .endAnimate();
    rRow[i].text
      .startAnimate({ delay: d + 180, duration: DUR, easing: E.easeOut })
      .setOpacity(1)
      .endAnimate();
  }
  await sd.pause();
