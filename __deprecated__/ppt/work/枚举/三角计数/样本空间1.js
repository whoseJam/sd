...
const func = box("abc构成一个合法三角形").width(240);
const answer = box("答案");

sd.init(() => {
    stkA.push(box("(1,1)")).push(box("(1,2)")).push(box("(1,3)")).push(new sd.Text(stkA, "...")).push(box("(n,n)"));
    stkB.push(box("(1,1)")).push(box("(1,2)")).push(box("(1,3)")).push(new sd.Text(stkB, "...")).push(box("(n,n)"));
    stkC.push(box("(1,1)")).push(box("(1,2)")).push(box("(1,3)")).push(new sd.Text(stkC, "...")).push(box("(n,n)"));
