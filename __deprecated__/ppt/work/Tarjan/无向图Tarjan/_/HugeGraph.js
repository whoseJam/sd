...
export class HugeGraph extends sd.ValueGridGraph {
    constructor(target, graphs, externLinks) {
        ...
        for (const link of externLinks) {
            ...
            const line = sd.Link(e1, e2, link[2]);
            line._.g1 = g1;
            line._.x1 = x1;
            line._.g2 = g2;
            line._.x2 = x2;
    ...
    outLinksAndNodes(u) {
        ...
        subgraph.outLinks(x, "undirect").forEach(link => {
            nodes.push(subgraph.toNode(link, x));
            links.push(link);
            ids.push([g, subgraph.toNodeId(link, x)]);
            if (subgraph.targetId(link) === String(x)) link.reversed = true;
        ...
        this.forEachExternLink((link, g1, x1, g2, x2) => {
            ...
            if (String(g2) === String(g) && String(x2) === String(x)) {
                nodes.push(this.node(g1, x1));
                links.push(link);
                ids.push([g1, x1]);
                link.reversed = true;
            }
