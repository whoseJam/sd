...
sd.main(async () => {
    ...
    halo2.startAnimate({ duration: 1200, delay: 200 }).setR(300).setOpacity(0.15).endAnimate();

    ring.startAnimate({ duration: 1500 }).setOpacity(0.6).setRotate(180).endAnimate();

    title.startAnimate({ duration: 800 }).setOpacity(1).setScale(1).endAnimate();

    subTitle.startAnimate({ duration: 800, delay: 400 }).setOpacity(1).setY(400).endAnimate();
